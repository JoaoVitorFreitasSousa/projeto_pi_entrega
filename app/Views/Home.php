...
<body>
	...
	<section class="produtos" id="produtos">
		...
		<div class="produtos-container">
			<div class="produtos-item purple">
				<h2>Purple</h2>
				<img src="/imgs/produtos1.jpg" alt="Produto-1">
			</div>
			<div class="produtos-item pink">
				<h2>Pink</h2>
				<img src="/imgs/produtos2.jpg" alt="Produto-2">
			</div>
			<div class="produtos-item blue">
				<h2>Blue</h2>
				<img src="/imgs/produtos3.jpg" alt="Produto-3">
			</div>
		</div>
	</section>
	...
	<section class="qualidade" id="qualidade">
		<div class="qualidade-item">
			<h2>Inteligente</h2>
			<p>
				O que temos que ter sempre em mente é que a determinação clara de objetivos afeta 
