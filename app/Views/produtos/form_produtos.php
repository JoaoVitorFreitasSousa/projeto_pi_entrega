        ...
        <div class="card p-4 mt-3 shadow-sm">
            <form action="/produtos/salvar" method="POST" class="border rounded p-4 bg-light">
                <div class="row mb-3">
                    <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="descricao" class="form-control" rows="3" placeholder="Digite a descrição do livro"></textarea>
                </div>
